import background2 from '../../../../assets/images/background/background.png';
import vader from '../../../../assets/images/elements/PikPng 1.png';
...
let HomeSectionTwo = `
<section id="section-two" class="section background--two" style="background-image: url(${background2})"> 
    ...
    <div class="block-section block-section--footer">
    ${footer}
    </div>
</section>
`
